...
import { Button, Img, Input, SelectBox, Switch, Text } from "components";
        ...
        <div className="absolute bg-black-900_7f_01 bottom-[0] flex flex-col font-montserrat inset-x-[0] items-end justify-end mx-auto md:pl-10 sm:pl-5 pl-[949px] w-full">
          <div className="bg-white-A700 flex flex-col items-center justify-start p-6 md:px-5 w-full">
            <div className="flex flex-col items-start justify-start mb-[690px] w-full">
              ...
              <SelectBox
                className="border border-gray-900_1e border-solid font-medium mt-6 rounded-lg text-left text-sm w-full"
                ...
                isMulti={false}
                name="frame2609131"
                options={checklistHistoryOptionsList}
                isSearchable={false}
                placeholder="Checklist History"
                size="md"
              />
            </div>
          </div>
...
export default Azmonk31ThreePage;
