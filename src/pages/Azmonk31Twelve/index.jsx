...
const Azmonk31TwelvePage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar3 className="!sticky !w-[245px] bg-black-900 flex h-screen md:hidden justify-start outline outline-indigo-50 overflow-auto md:px-5 top-[0]" />
          <div className="flex flex-1 flex-col font-inter items-center justify-start md:px-5 w-full">
            ...
            <div className="font-montserrat sm:h-[1817px] h-[1848px] md:h-[2175px] relative w-full">
              <div className="absolute h-[1817px] md:h-[2175px] inset-[0] justify-center m-auto w-full">
                <div className="absolute flex md:flex-col flex-row gap-px h-full inset-[0] items-end justify-evenly m-auto w-auto">
                  <div className="flex flex-col gap-7 h-[1663px] md:h-auto items-start justify-start p-6 sm:px-5 w-[597px] md:w-full">
                    <div className="flex flex-col relative w-full">
                      <div className="bg-white-A700 flex flex-col gap-7 h-[818px] md:h-auto items-center justify-start mx-auto outline outline-indigo-50 p-6 sm:px-5 w-[597px] md:w-full">
                          ...
                          <div className="flex flex-col gap-5 items-start justify-start w-auto sm:w-full">
                            <div className="flex sm:flex-col flex-row gap-5 items-start justify-start w-auto sm:w-full">
                              <div className="flex flex-col gap-2 items-start justify-start w-[264px]">
                                ...
                                <div className="bg-white-A700 border border-black-900_28 border-solid flex flex-col h-[60px] md:h-auto items-center justify-between p-3 rounded w-full">
                                  <div className="flex flex-row gap-3 items-center justify-start w-60">
                                    <Img
                                      className="h-5 w-5"
                                      src="/images/img_frame_light_blue_a700_20x20.svg"
                                      alt="frame_Six"
                                    />
                                    <div className="flex flex-col gap-1 items-start justify-center w-auto">
                                      <Text
                                        className="text-black-900_cc text-sm w-auto"
                                        size="txtMontserratRomanSemiBold14Black900cc"
                                      >
                                        Upload File
                                      </Text>
                                      <Text
                                        className="text-[10px] text-black-900_7f w-auto"
                            ...
                            <div className="flex flex-col items-start justify-start w-auto">
                              <div className="flex flex-col gap-2 items-start justify-start w-[264px]">
                                ...
                                <List
                                  className="sm:flex-col flex-row gap-3 grid grid-cols-3 justify-start w-auto"
                      ...
                      <div className="bg-white-A700 flex flex-col gap-4 items-start justify-start mt-[-81px] mx-auto w-auto z-[1]">
                        <Text
                          className="text-black-900 text-lg w-auto"
                          size="txtMontserratRomanSemiBold18Black900"
                        >
                            ...
                            <div className="flex flex-col gap-[7.37px] items-start justify-start w-auto">
                              ...
                              >
                                <>
                                  ...
                                  Yo-Yo Bungee. Complies with ASTM, CCPSA,
                                  CPSIA, Prop 65. 2.75&quot; Diameter
                                </>
                              </Text>
                            </div>
                  ...
                  <div className="flex sm:h-[1268px] md:h-[941px] h-[972px] justify-end pt-[154px] relative w-1/2 md:w-full">
                    <div className="flex h-[818px] md:h-[941px] justify-end mt-auto mx-auto w-full">
                      <div className="bg-gray-50 h-[941px] mt-auto mx-auto rotate-[90deg] w-full"></div>
                      <div className="absolute flex flex-row sm:gap-10 inset-x-[0] items-start justify-between mx-auto top-[3%] w-[93%]">
                        <Text
                    ...
                    <div className="absolute bg-white-A700 bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto outline outline-[0.5px] outline-indigo-50 rounded-lg w-[92%]">
                      ...
                      <div className="flex flex-col gap-[14.74px] items-start justify-start p-[18.42px] w-auto sm:w-full">
                        ...
                        <div className="bg-gray-50 flex sm:flex-col flex-row gap-[22.1px] items-start justify-start p-[14.74px] w-[511px] sm:w-full">
                          <Img
                          ...
                          <div className="flex flex-col gap-[18.42px] items-start justify-start w-auto">
                            ...
                            <div className="flex flex-col gap-[37px] items-start justify-start w-[198px]">
                              <div className="flex flex-row items-start justify-start w-auto">
                                <Text
                                  className="bg-gray-400 justify-center outline outline-[0.5px] outline-indigo-50 pt-[11px] sm:px-5 px-[21px] text-[12.89px] text-white-A700 w-[66px]"
                                  size="txtMontserratRomanSemiBold1289WhiteA700"
                                >
                                  Qty
                                </Text>
                        ...
                        <div className="font-montserrat h-[74px] relative w-[86%] md:w-full">
                          <div className="absolute h-[74px] inset-[0] justify-center m-auto w-[98%] md:w-full">
                            <div className="bg-white-A700 flex flex-row flex-wrap gap-[11px] h-full items-center justify-end m-auto max-w-[1195px] outline outline-indigo-50 px-4 py-5 w-full">
                              ...
                              <Button
                                className="cursor-pointer flex items-center justify-center min-w-[130px] outline outline-[0.5px] outline-light_blue-A700 rounded-md"
                                leftIcon={
                                  <Img
                                    className="h-[18px] mr-2"
...
export default Azmonk31TwelvePage;
