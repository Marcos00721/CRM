  ...
  return (
    <>
      <Sidebar className={props.className}>
        <div className="flex flex-row gap-4 items-center justify-between mb-[889px] mt-6 px-2 w-[245px] md:w-full">
          <Img
        ...
        <div className="flex flex-col items-start justify-start mb-[681px] mt-[70px] w-auto md:w-full">
